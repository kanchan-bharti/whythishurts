...
import { data } from './HandAcheDataBase';
...
class HandPainRemoval extends React.Component {
    constructor() {
        super();
        this.state = {
            filtered: false,
            ...
            <Container  className="text-left">
                ...
                <Row>
                    ...
                    <div className="col-12 col-md-7 col-lg-6  px-lg-4 pb-3 py-lg-0">
                        {this.state.filtered ? (
                            <div>
                                <p className="h2 mb-3">Why does my Hand hurt?</p>
                    ...
                    <p className="h2">Overview</p>
                                    <p>
                                        Hand pain can originate in different parts:
                                    </p>
                                    <ul>
                                        <li>Bones</li>
                                        <li>Joints</li>
                                    ...
                                    <p>
                                        Common reasons for hand pain can include:                                    </p>
                                    <ul>
                                        <li>Inflammation</li>
                                        <li>Nerve damage</li>
                                        <li>Sprains</li>
...
export default HandPainRemoval;