...
import { data } from './KneeAcheDatabase';
...
class KneePainRemoval extends React.Component {
    constructor() {
        super();
        this.state = {
            filtered: false,
            ...
            <Container  className="text-left">
                ...
                <Row>
                    ...
                    <div className="col-12 col-md-7 col-lg-6  px-lg-4 pb-3 py-lg-0">
                        {this.state.filtered ? (
                            <div>
                                <p className="h2 mb-3">Why does my Knee hurt?</p>
                    ...
                    <div className="col-12 col-lg-3 ">
                        ...
                        <p>Knee pain is a common complaint that affects people of all ages. Knee pain may be the result of an injury, such as a ruptured ligament or torn cartilage. Medical conditions — including arthritis, gout and infections — also can cause knee pain.</p>
                        <p>Many types of minor knee pain respond well to self-care measures. Physical therapy and knee braces also can help relieve pain. In some cases, however, your knee may require surgical repair.</p>
                    </div>
                </Row>
            </Container >
...
export default KneePainRemoval;