...
import { data } from './FootAcheDatabase_male';
...
class FootPainRemoval extends React.Component {
    constructor() {
        super();
        this.state = {
            filtered: false,
            ...
            <Container className="text-left">
                ...
                <Row>
                    ...
                    <div className="col-12 col-md-7 col-lg-6  px-lg-4 pb-3 py-lg-0">
                        {this.state.filtered ? (
                            <div>
                                <p className="h2 mb-3">Why does my Foot hurt?</p>
                            ...
                            (
                                <div>
                                    <p className="h2">Causes of Knee Ache</p>
                    ...
                    <div className="col-12 col-lg-3 ">
                        ...
                        <p>Foot pain can occur due to certain lifestyle choices or a medical condition. </p>
                        <p className="h2">Some common causes of pain in your Foot</p>
                        <ol>
                            <li>
                                <p>Diabetes Mellitus can also cause complications and several disorders of the feet. People with diabetes are more prone to:</p>
                                <ul>
                                    <li>nerve damage in the feet</li>
                                    <li>clogged or hardened arteries in the legs and feet</li>
                                    <li>foot ulcers or sores</li>
                                </ul>
                            </li>
                            <li>
                                <p>You’re also more at risk for having foot pain if:</p>
                                <ul>
                                    <li>have overweight or obesity</li>
                                    <li>are pregnant</li>
                                    <li>have a foot injury such as a sprain, fracture, or tendinitis</li>
                                </ul>
                            </li>
                            <li>
                                <p>Lifestyle choices: One of the main causes of foot pain is wearing shoes that don’t fit properly. Wearing high-heeled shoes can often cause foot pain because they place a great deal of pressure on the toes.</p>
                            </li>
                        </ol>
...
export default FootPainRemoval;