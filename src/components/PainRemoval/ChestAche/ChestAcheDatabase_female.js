        ...
        causes: [
            {
                ...
                symptoms: [
                    {
                        pain: ['Sqeezing', 'Spreading to your neck', 'Spreading to jaw', 'Spreading to back'],
            ...
            },
            {
                ...
                symptoms: [
                    {
                        pain: ['Stabbing'],
                        with: ['Lightheadedness', 'Fatigue', 'Nausea', 'Shortness of breath', 'Sweating', 'Burning', 'Abdominal Pain']
                    }
                ],
                preventive_treatment: {
                    used_when: '',
                ...
                symptoms: [
                    {
                        ...
                        with: ['Racing heartbeats', 'Shortness of breath', 'Leg swelling', 'Fluid retention', 'Ankles/Feet swelling', 'Fatigue', 'Headache', 'Body aches', 'Joint pain', 'Fever', 'Sore throat', 'Diarrhea']
                    }
                ],
                preventive_treatment: {
                    used_when: '',
            ...
            },
            {
                ...
                symptoms: [
                    {
                        pain: ['Severe', 'Sudden'],
                        with: ['Pain in upper back', 'Abdominal pain', 'Lightheadedness', 'Loss of consciousness', 'Shortness of breath', 'Weakness', 'Paralysis of one side of body', 'Loss of vision', 'Leg Pain']
                    }
                ],
                preventive_treatment: {
                    used_when: '',
                ...
                symptoms: [
                    {
                        ...
                        with: ['Cough','Racing heartbeats','Lightheadedness','Sweating','Fever','Leg pain','Leg swelling','Clammy or discolored skin (Cynosis)']
                    }
                ],
                preventive_treatment: {
                    used_when: '',
            ...
            },
            {
                ...
                symptoms: [
                    {
                        pain: ['Tender','Gets triggered when you press on an area (injured)','Get triggered when you bend'],
                        with: ['Swelling']
                    }
                ],
                preventive_treatment: {
            ...
            },
            {
                title: 'Breast Cancer',
                article: [],
                causes: ['Doctors know that breast cancer occurs when some breast cells begin to grow abnormally. These cells divide more rapidly than healthy cells do and continue to accumulate, forming a lump or mass. Cells may spread (metastasize) through your breast to your lymph nodes or to other parts of your body.','Inheritance (in some cases): Doctors estimate that about 5 to 10 percent of breast cancers are linked to gene mutations passed through generations of a family.'],
                symptoms: [
                    {
                        pain: ['Tender'],
                        with: ['Breast lump','Breast unusual thickening','Breast shape change','Breast skin appearance change','New inverted nipple','Redness on breast']
                    }
                ],
                preventive_treatment: {
                    used_when: '',
